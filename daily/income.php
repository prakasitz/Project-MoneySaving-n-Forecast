                    ...
                    <form action="income_db.php" id="form-record-income" method="GET" class="form-horizontal">
                        ...
                        <div class="row form-group">
                            <div class="input-group col-lg-12">
                                ...
                                <input type="text" step="0.01" min="" id="input-money-income" name="moneyIncome"  onkeyup="dokeyup(this);"  onkeypress="checknumber()"  maxlength="12" class="form-control" placeholder="จำนวนเงิน"required> 
